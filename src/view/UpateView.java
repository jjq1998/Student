...
public class UpateView extends JFrame
{
    ...
    public UpateView()
    {
        ...
        jButtonOK.addActionListener(e ->
        {
            try
            {
                int i = StudentDAO.update(Integer.valueOf(sno.getText()), Integer.valueOf(c_id.getText()), name.getText(), sex.getText(), birth.getText(), address.getText(), dormitory.getText(), tel.getText(), duty.getText());
                if (i == 0)
                {
                    new ErrorView2(this);
                }
